...
<div id="lingua-translation-modal" class="lingua-modal" style="display: none;">
    <div class="lingua-modal-content">
        <div class="lingua-resize-handle" title="<?php esc_html_e('Drag to resize panel', 'iqcloud-translate'); ?>"></div>
        <div class="lingua-modal-header">
            <h2><?php esc_html_e('Translate Content', 'iqcloud-translate'); ?></h2>
        ...
        <div class="lingua-modal-body">
            <div class="lingua-translation-controls">
                <div class="lingua-language-selector">
                    <div class="lingua-source-lang-display">
                        <label><?php esc_html_e('From:', 'iqcloud-translate'); ?></label>
                    ...
                    <label for="lingua-target-lang"><?php esc_html_e('To:', 'iqcloud-translate'); ?></label>
                ...
                <div class="lingua-search-container-full">
                    <input type="text" id="lingua-live-search" placeholder="<?php esc_html_e('Search strings...', 'iqcloud-translate'); ?>" class="lingua-search-input-full">
            ...
            <div class="lingua-content-sections">
                ...
                <div class="lingua-section lingua-seo-section" style="display: none !important;">
                    <h3><?php esc_html_e('SEO Fields', 'iqcloud-translate'); ?></h3>
                    
                    <!-- SEO Title -->
                    <div class="lingua-translation-pair lingua-seo-field">
                        <div class="lingua-original">
                            <label><?php esc_html_e('SEO Title', 'iqcloud-translate'); ?></label>
                            <input type="text" id="lingua-original-seo-title" readonly />
                        </div>
                        <div class="lingua-translated">
                            <label><?php esc_html_e('Translation', 'iqcloud-translate'); ?></label>
                    ...
                    <div class="lingua-translation-pair lingua-seo-field">
                        <div class="lingua-original">
                            <label><?php esc_html_e('SEO Description', 'iqcloud-translate'); ?></label>
                ...
                <div class="lingua-section" style="display: none !important;">
                    <h3><?php esc_html_e('Title', 'iqcloud-translate'); ?></h3>
                    <div class="lingua-translation-pair">
                        <div class="lingua-original">
                            <label><?php esc_html_e('Original', 'iqcloud-translate'); ?></label>
                ...
                <div class="lingua-section" id="lingua-woo-short-desc-section" style="display: none;">
                    <h3><?php esc_html_e('WooCommerce Short Description', 'iqcloud-translate'); ?></h3>
                    <div class="lingua-translation-pair">
                        <div class="lingua-original">
                            <label><?php esc_html_e('Original', 'iqcloud-translate'); ?></label>
                ...
                <div class="lingua-section" style="display: none !important;">
                    <h3><?php esc_html_e('Excerpt', 'iqcloud-translate'); ?></h3>
                    <div class="lingua-translation-pair">
                        <div class="lingua-original">
                            <label><?php esc_html_e('Original', 'iqcloud-translate'); ?></label>
                ...
                <div class="lingua-section" id="lingua-tabbed-section">
                    ...
                    <div class="lingua-tab-navigation">
                        <button class="lingua-tab-button active" data-tab="seo">
                            ...
                            <span class="lingua-tab-label"><?php esc_html_e('SEO', 'iqcloud-translate'); ?></span>
                        ...
                        <button class="lingua-tab-button" data-tab="content">
                            ...
                            <span class="lingua-tab-label"><?php esc_html_e('Page Content', 'iqcloud-translate'); ?></span>
                        ...
                        <button class="lingua-tab-button" data-tab="media">
                            ...
                            <span class="lingua-tab-label"><?php esc_html_e('Media', 'iqcloud-translate'); ?></span>
                    ...
                    <div class="lingua-tab-panels">
                        ...
                        <div class="lingua-tab-panel active" id="lingua-seo-panel" data-tab="seo">
                            <div class="lingua-seo-header">
                                <h4><?php esc_html_e('SEO Optimization', 'iqcloud-translate'); ?></h4>
                                <p class="lingua-seo-description"><?php esc_html_e('Translate your page title and meta description for better search engine visibility', 'iqcloud-translate'); ?></p>
                            </div>
                        ...
                        <div class="lingua-tab-panel" id="lingua-content-panel" data-tab="content">
                            <div class="lingua-strings-summary" id="lingua-content-summary" style="display: none;">
                                <strong><?php esc_html_e('Extracted Elements:', 'iqcloud-translate'); ?></strong>
                                <span id="lingua-total-content-count">0</span> <?php esc_html_e('translatable elements found', 'iqcloud-translate'); ?>
                            </div>
                        ...
                        <div class="lingua-tab-panel" id="lingua-media-panel" data-tab="media">
                            <div class="lingua-media-header">
                                <h4><?php esc_html_e('Media Translation', 'iqcloud-translate'); ?></h4>
                                <p class="lingua-media-description"><?php esc_html_e('Translate image alt text, captions, and replace images for different languages', 'iqcloud-translate'); ?></p>
                            </div>
                ...
                <div class="lingua-section" id="lingua-meta-section" style="display: none !important;">
                    <h3><?php esc_html_e('Meta Fields', 'iqcloud-translate'); ?></h3>
        ...
        <div class="lingua-modal-footer">
            <div class="lingua-progress">
                ...
                <span class="lingua-progress-text"><?php esc_html_e('Ready to translate', 'iqcloud-translate'); ?></span>
            </div>
            ...
            <div class="lingua-footer-actions">
                <button type="button" id="lingua-save-translation" class="button button-primary" disabled>
                    ...
                    <?php esc_html_e('Save Translation', 'iqcloud-translate'); ?>
                </button>
            </div>
        </div>
    </div>
...
<script type="text/template" id="lingua-content-block-template">
    <div class="lingua-translation-pair lingua-content-block" data-block-id="{block_id}">
        <div class="lingua-original">
            <label><?php esc_html_e('Original', 'iqcloud-translate'); ?> #{block_id}</label>
            <div class="lingua-content-preview">{original_content}</div>
            <textarea class="lingua-original-text" readonly>{original_text}</textarea>
        </div>
        <div class="lingua-translated">
            <label><?php esc_html_e('Translation', 'iqcloud-translate'); ?> #{block_id}</label>
